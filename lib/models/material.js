...
(function() {
  var RequestUrls, assert, debuglog, fs, getMaterialById, helps, loadMaterialCount, loadMaterialList, path, request, uploadMedia, _;
  ...
  uploadMedia = function(access_token, type, filepath, callback) {
    var url;
    assert(_.isFunction(callback), "missing callback");
    return url = "" + RequestUrls.MEDIA_UPLOAD_URL + "?access_token=" + access_token + "&type=" + type;
  };
