...
(function() {
  var PAY_DEFAULT_PARAMS, RequestUrls, assert, crypto, debuglog, getBrandWCPayRequestParams, helps, makePaySignature, payValidate, request, _;
  ...
  payValidate = function(xml, callback) {
    ...
    return helps.xml2json(xml, (function(_this) {
      return function(err, data) {
        ...
        if (!((data.mch_id != null) && data.mch_id === _this.mchId)) {
