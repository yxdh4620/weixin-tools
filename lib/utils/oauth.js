...
(function() {
  var RESPONSE_TYPE, RequestUrls, SCOPEN_TYPES, assert, debuglog, generateAuthorizeURL, loadAuthorzeToken, loadUserInfo, querystring, refreshAuthorzeToken, request, _;
  ...
  generateAuthorizeURL = function(appid, redirect, state, scope) {
    var info;
    info = {
      appid: appid,
  ...
  loadAuthorzeToken = function(appid, secret, code, callback) {
    var options, url;
  ...
  refreshAuthorzeToken = function(appid, refresh_token, callback) {
    var options, url;
